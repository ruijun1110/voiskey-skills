...
| Codex（ChatGPT 桌面应用） | [Codex](#codex) | 收到通知后在 Codex 里发一句话 |
...
在 Codex 的对话框里发送下面这句话：

```
$skill-installer 从 https://github.com/ruijun1110/voiskey-skills/tree/main/plugins/voiskey-copy/skills/voiskey-copy 安装这个 Skill
```

Codex 可能会请你允许联网或写入文件，点允许即可。装好后开一个新对话就能用。

**更新：** 收到更新通知后，在 Codex 的对话框里发送：

```
删除 ~/.codex/skills/voiskey-copy，然后用 $skill-installer 从 https://github.com/ruijun1110/voiskey-skills/tree/main/plugins/voiskey-copy/skills/voiskey-copy 重新安装这个 Skill
```
...
- **Codex 用户：** 发通知，请他们在 Codex 里发送上面的更新指令。
